...
This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) using TypeScript.

To reproduce the setup process follow the instruction [here](https://github.com/Microsoft/TypeScript-React-Starter)
...
```js
  "homepage": "https://myusername.github.io/MaterialUI-React-POC",
```
...
To publish it at [https://myusername.github.io/MaterialUI-React-POC](https://myusername.github.io/MaterialUI-React-POC), run:
